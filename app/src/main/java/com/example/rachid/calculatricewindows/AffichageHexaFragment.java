 ...
 */
public class AffichageHexaFragment extends Fragment implements OnModelChangeListener{
    ...
    public void notifyModelChange() {
        ...
        textView.setText(Integer.toHexString(new Integer(this.calculatriceModel.getNombreEnCours())));
    }
