 ...
 */
public class AffichageBinaireFragment extends Fragment implements OnModelChangeListener{
    ...
    public void notifyModelChange() {
        ...
        textView.setText(Integer.toBinaryString(new Integer(this.calculatriceModel.getNombreEnCours())));
    }
